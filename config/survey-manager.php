...
return [
    ...
    */
    ...
    // route middleware
    'route_middleware'          =>  ['web', 'auth', '2fa', 'admin'],

    // api middleware
    //'api_middleware'            =>  ['api', 'auth:sanctum'],
    'api_middleware'            =>  ['web', 'auth', '2fa', 'admin'],

    // admin middleware
    'admin_middleware'          =>  ['web', 'auth', '2fa', 'admin'],
    ...
    */
    ...
    'builder'                   =>  [
        ...
        'questionTypes'        => ["text", "checkbox", "radiogroup", "dropdown", "comment", "html", "matrix"],
