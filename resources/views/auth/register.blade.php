        ...
        <div class="card-body login-card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label class="required" for="status_id">{{ trans('Team') }}</label>
                        <select class="form-control select2 selectpicker {{ $errors->has('team') ? 'is-invalid' : '' }}" data-live-search="true" name="team_id" id="team_id" required>
