    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('survey_management_access')
                <li class="nav-item">
                    <a href="{{ route("admin.esurvey.index") }}" class="nav-link {{ request()->is("admin/esurvey*") || request()->is("admin/survey/*") ? "active" : "" }}">
                        <i class="fa-fw nav-icon fas fa-calendar-alt">

                        </i>
                        <p>
                            {{ trans('Survey Manager') }}
                        </p>
                    </a>
                </li>
                @endcan
