...
<div class="card">
    ...
    <div class="card-body">
         ...
         <ul class="nav nav-tabs">
             ...
             <li class="nav-item">
                 <a class="nav-link {{request()->is("admin/esurvey/$id/result/unit-search")?'active':'' }}" href="{{ route('admin.esurvey.result.unitSearch',$id) }}" style="text-decoration: none !important;color:black">Generate Unit Survey Result</a>
             </li>
         ...
         <br>
            ...
            <form action="{{ route("admin.esurvey.result.unit",$id) }}"  enctype="multipart/form-data"  method="POST" >
                @csrf              
                <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach ($result as $row => $value)
                                    ...
                                    @else
                                        <button type="button" class="btn btn-outline-secondary disabled">{{$value}}</button>
                                    @endif
